...
if ($useSitemap) {
    Route::statamic('/sitemaps.xml', 'statamic-vanilla-peak-seo::sitemap/sitemaps', [
        'layout' => null,
...
if ($useSitemap || $useSocialImageGeneration) {
    Site::all()->each(function (\Statamic\Sites\Site $site) use ($useSitemap, $useSocialImageGeneration) {
        ...
        // The Sitemap route.
        if ($useSitemap) {
            Route::statamic(URL::tidy($relativeSiteUrl . '/sitemap.xml'), 'statamic-vanilla-peak-seo::sitemap/sitemap', [
                'layout' => null,
                'content_type' => 'application/xml'
            ]);
        }
        ...
        if ($useSocialImageGeneration) {
            Route::statamic(URL::tidy($relativeSiteUrl . '/social-images/{id}'), 'statamic-vanilla-peak-seo::social_images', [
                'layout' => null,
            ]);
        }
    });
