...
class ServiceProvider extends AddonServiceProvider
{
    ...
    {
        $this->publishes([
            __DIR__ . '/../resources/fieldsets' => resource_path('fieldsets/vendor/statamic-vanillia-peak-seo'),
        ], 'statamic-vanillia-peak-seo-fieldsets');
    }

    protected function registerPublishableViews()
    {
        $this->publishes([
            __DIR__ . '/../resources/views' => resource_path('views/vendor/statamic-vanillia-peak-seo'),
        ], 'statamic-vanillia-peak-seo-views');
    }
}
